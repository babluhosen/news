...
if(isset($_POST['C_Update'])){
    ...
    $ucid=$_POST['uC_id'];
    $uID=$_POST['upadeid'];
   $update=" UPDATE tble_news SET title='$title', icon='$icons', descrip='$udesc', c_id='$ucid' WHERE id=$uID";
...
$edit=$_GET['id'];
//select query//
$selectquery="SELECT * FROM tble_news WHERE id=$edit";
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                 ...
                                 <div class="row ">
                                    ...
                                    <div class="col-lg-4">
                                      <label for="n_title" class="form-label">Title</label>
                                       <input value="<?php echo $varfinal['title']; ?>" type="text" name="uTitle" id="uTitle" class="form-control" required>
                                    </div>
                                    <div class="col-lg-4">
                                      <label for="n_icon" class="form-label">Icon</label>
                                       ...
                                       <div class="col-lg-4">
                                      <label for="n_icon" class="form-label">Description</label>
                                       <input type="text" value="<?php echo $varfinal['descrip']; ?>" name="uDesc" id="uDesc" class="form-control" required>
                                    </div>
                                       <div class="col-lg-4">
                                      <label for="n_icon" class="form-label">Category ID</label>
                                       <input type="text" value="<?php echo $varfinal['c_id']; ?>" name="uC_id" id="uC_id" class="form-control" required>
                                    </div>
       ...
       <a href="news.php" class="btn btn-success bt mt-4 btn-sm" style="border-radius: 20px" title="Category Page"><i class="fas fa-plus"></i></a>
        </div>
...
<?php
  ...
  header("location:news.php");//return to category
}
